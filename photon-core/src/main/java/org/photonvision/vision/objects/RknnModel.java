...
public class RknnModel implements Model {
     ...
     */
    public RknnModel(File modelFile, List<String> labels, RknnJNI.ModelVersion version, Size inputSize)
        ...
        logger.info("RknnModel created for: " + modelFile.getName() + ", Version: " + version + ", Size: " + inputSize);
    }
